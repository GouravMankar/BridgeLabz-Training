...
public class TourMateApp {
	public static void main(String[] args) {
		...
		Trip domesticTrip = new DomesticTrip("Goa", 4, domesticTransport, domesticHotel, Arrays.asList(d1, d2));
		...
		Trip trip = new InternationalTrip("Dubai", 5, transport, hotel, Arrays.asList(a1, a2));
