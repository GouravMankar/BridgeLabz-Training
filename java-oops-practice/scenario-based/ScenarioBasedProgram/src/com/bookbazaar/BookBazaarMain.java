...
public class BookBazaarMain {
	...
	public static void main(String[] args) {
		...
		Book ebook = new EBook("Java Mastery", "James Gosling", 500.0, 10);

		Book printedBook = new PrintedBook("Clean Code", "Robert C. Martin", 800.0, 5);

		// Create order
		Order order = new Order("Gourav Mankar");
