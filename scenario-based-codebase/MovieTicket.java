...
public class MovieTicket {
    ...
    public static void main(String args[]) {
        ...
        char nextCustomer;
        int numberOfSeats,numberOfSnacks;
        ...
        do {
            ...
            if (snackOption == 'y') {
                ...
                System.out.print("Enter number of Snacks item : ");
                numberOfSnacks=sc.nextInt();

                switch (snackChoice) {
                    case 1 -> { System.out.println("Popcorn added."); totalBill += 100*numberOfSnacks; }
                    case 2 -> { System.out.println("Samosa added."); totalBill += 50*numberOfSnacks; }
                    case 3 -> { System.out.println("Beverages added."); totalBill += 80*numberOfSnacks; }
                    case 4 -> { System.out.println("Pizza added."); totalBill += 150*numberOfSnacks; }
                    case 5 -> { System.out.println("Nachos added."); totalBill += 120*numberOfSnacks; }
