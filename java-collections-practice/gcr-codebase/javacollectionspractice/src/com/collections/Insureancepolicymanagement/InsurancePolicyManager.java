...
public class InsurancePolicyManager {
    ...
    public static void main(String[] args) {
        ...
        manager.addPolicy(new Policy(101, "Suresh", LocalDate.now().plusDays(10), "Health"));
        manager.addPolicy(new Policy(102, "Dinesh", LocalDate.now().plusDays(40), "Car"));
        manager.addPolicy(new Policy(103, "Sanjay", LocalDate.now().minusDays(2), "Life"));
